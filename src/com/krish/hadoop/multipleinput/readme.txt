Topic: Hadoop Multiple Inputs

Requirement:
Given 2 or more different files having different formats (layouts) and different delimiters, etc
Need to process these files and perform some aggregation on these 2 or more files in a single job

Solution:
Hadoop Multiple Inputs

*************************************************************************************
Input File1 Format (layout), Comma delimited
...
Input File2 Format (layout), Pipe delimited
TRANSACTIONID|TRANSACTIONDATE|PRODUCTID|UNITPRICE|PAYMENTTYPE|CARDNUMBER|QUANTITY|CATEGORYID|SUPPLIERID|CUSTOMERID|FIRSTNAME|LASTNAME|PHONE|EMAIL|ADDRESS|CITY|STATE|ZIP|COUNTRY|SUPPLIERNAME|SUPPLIERPHONE|SUPPLIEREMAIL|CATEGORYBRAND|CATEGORYTYPE

Sample Input Data:
388963|5/19/2015|7943|32.32|china-unionpay|5602240000000000000|8|353|191|1337|Sean|Graham|8-(108)562-0795|sgrahamro@omniture.com|4 Hovde Parkway|Brooklyn|New York|11241|United States|Blogtag|1-(097)665-4577|sgrahamro@whitehouse.gov|BabyGanics Alcohol Free Foaming Hand Sanitizer|BENZALKONIUM CHLORIDE
