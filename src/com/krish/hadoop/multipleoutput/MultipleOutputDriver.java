...
public class MultipleOutputDriver extends Configured implements Tool {
	...
	public static void main(String[] args) throws Exception {
		if (args == null || args.length < 3 || args[0] == null
			...
			System.out
					.println("Usage: hadoop jar HadoopEssentials.jar com.krish.hadoop.multipleoutput.MultipleOutputDriver <inputpath> <outputpath> <delimiter>");
		}
	...
	public int run(String[] args) throws Exception {
		...
		job.setJarByClass(com.krish.hadoop.multipleoutput.MultipleOutputDriver.class);
		job.setMapperClass(com.krish.hadoop.multipleoutput.MultipleOutputMapper.class);
